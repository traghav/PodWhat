...
<!--       <div class="image phone">
        <div class="inner">
          <img src="https://www.shareicon.net/download/2016/08/05/689905_record_512x512.png">
        </div>
      </div> -->
   </header>
...
/* Spotlight */
  ...
  @media screen and (max-width: 7px) and (orientation: landscape) {
  ...
  @media screen and (max-width: 7px) and (orientation: portrait) {
...
/* Wrapper */
  ...
  @media screen and (max-width: 10px) and (orientation: landscape) {
